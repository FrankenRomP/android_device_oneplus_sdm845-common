...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private boolean launchSpecialActions(String value) {
        if (value.equals(AppSelectListPreference.TORCH_ENTRY)) {
            ...
            FrankenUtils.sendKeycode(KeyEvent.KEYCODE_PAGE_DOWN);
            return true;
        } else if (value.equals(AppSelectListPreference.BROWSE_SCROLL_UP_ENTRY)) {
            FrankenUtils.sendKeycode(KeyEvent.KEYCODE_PAGE_UP);
            return true;
            ...
            FrankenUtils.sendKeycode(KeyEvent.KEYCODE_APP_SWITCH);
            return true;
        }
        return false;
    }
